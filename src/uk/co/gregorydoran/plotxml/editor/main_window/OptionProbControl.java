...
public class OptionProbControl extends JPanel {
	...
	public OptionProbControl(ProbType p) {
		...
		jSlider.setValue(Math.round(jSlider.getMaximum()/probType.getValue()));
	}
		...
		if (jSlider == null) {
			...
			jSlider.addChangeListener(new javax.swing.event.ChangeListener() {
				public void stateChanged(javax.swing.event.ChangeEvent e) {
					...
					probType.setValue(new Float(((double)jSlider.getValue())/((double)jSlider.getMaximum())));
			...
			jTextField.addCaretListener(new javax.swing.event.CaretListener() {
				public void caretUpdate(javax.swing.event.CaretEvent e) {
					try
					{
						...
						probType.setValue(Float.parseFloat(jTextField.getText()));
